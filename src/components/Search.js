const Search = () => {
    return ( 
        <div className="text-[#33A2FF] max-w-[1240px] mx-auto p-4 flex">
            ...
            <button className="btn px-6 py-2.5 bg-[#33A2FF] text-[#33A2FF] leading-tight uppercase rounded hover:bg-[#64ffda] transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
